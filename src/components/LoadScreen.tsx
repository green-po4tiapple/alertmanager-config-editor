 ...
 * actually supplied — pasted, opened, pulled from a live Alertmanager, or the
 * example loaded by an explicit click.
 */
  ...
  return (
    <div className="load-screen">
      <div className="load-card">
        ...
        <div className="am-pull">
          <div className="eyebrow">{t.load.pullTitle}</div>
          <span className="hint">
        ...
        <div className="or-divider">{t.load.orPaste}</div>
